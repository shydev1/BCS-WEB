...
<h1 id="4" style={{fontSize:40, color: "#b30000", fontWeight: "bold", paddingTop: 30 }}  className="  text-center">SACRAMENTS</h1>
...
<h3 style={{fontSize:25, paddingLeft: 30, color: "#b30000", fontWeight: "bold", paddingTop: 10 }}  className="">BAPTISM:</h3>
...
<h3 style={{fontSize:25, paddingLeft: 30, color: "#b30000", fontWeight: "bold", paddingTop: 0 }}  className="">MARRIAGE BLESSING:</h3>
            <h6 style={{ color: "#333", padding: 10, }}  className="">
            Marriage blessing is also one of the sacraments in Brotherhood. Marriage as holy institution is recommended for all brethren of the fold, if they so which but on one condition that a man be husband to one wife, and a woman be wife to one husband. Solemnization of marriage in Brotherhood is the highest anybody can desire to experience because it is done by the Holy Spirit. The Father therefore advises that all brethren have their marriage blessed, even if they were married in court or church prior to their baptism into the fold.
            </h6>
            <h6 style={{ color: "#333", padding: 10, }}  className="">
            Any man or woman who does not practice strict monogamy should remain a celibate. Trial, contract marriages are not allowed in Brotherhood. Once a man’s marriage is blessed, such cannot marry again except on the grounds of adultery or demise of one of the partners. All married couples, indeed all brethren, are advised to go and read the publication entitled “key to successful marriage” -sermons by Leader Olumba Olumba Obu.
            </h6>
<h3 style={{fontSize:25, paddingLeft: 30, color: "#b30000", fontWeight: "bold", paddingTop: 0 }}  className="">LOVE FEAST:</h3>
            <h6 style={{ color: "#333", padding: 10, }}  className="">
            Love feast is sacrament introduced by the Holy Spirit in Brotherhood of the Cross and Star. It is to commemorate the Passover last supper, during which our God and savior changed bread to his living Body, and wine to his priceless Blood. We daily celebrate the Holy Communion or the Love Feast.               </h6>
            <h6 style={{ color: "#333", padding: 10, }}  className="">
            The love feast is very sacred and can accomplish anything. Feast is not food that you can eat to be filled. Thus a piece of bread, biscuit, banana, orange, paw-paw, pineapple and even a spoon full of rice is enough for one to eat as feast. Feast should be bought, prepared and eaten with utmost reverence and respect to the Holy Spirit. Nobody should struggle and fight for feast.
                        </h6>
            <h6 style={{ color: "#333", padding: 10, }}  className="">
            When feast is served, everyone should kneel down when he or she collects same. No special time has been set for feast conducting. No special fruits are recommended for feast. No conditions, modality or amount are stipulated for celebration of feast. Feast in Consist of fruits, vegetables, rice etc., and water. It is purely vegetarian and is blessed and served after service or fasting.
                                    </h6>
            <h6 style={{ color: "#333", padding: 10, }}  className="">
            Feast could be of two types
Fruit feast: prepared basically with various types of fruit.
Full feast: consist of both fruits and food. There is also house feast, which could be fruits or full. BCS members do house feast or blessing before or shortly after they move into a new house and also at will, as the Holy Spirit reveals or directs. Acts 2:42-47.
BCS members neither kill, eat nor offer meat or fish; nor do they eat any dairy product. In BCS, Vegetarian is practiced. Eating of fruits is very important and significant, hence BCS members usually have fruits at their homes; fruits are served to visitor or strangers in place of drinks. Genesis 1:29., BCS members do not drink or offer alcoholic drink, wine, soft or any artificially mixed drink except water. Smoking and snuffing is not the food of the Holy Spirit and it is not acceptable in BCS. 
                        </h6>
                        ...
                        <Link
                         ...
                         role='button' to={'/Events'} class="text-white text-center bg-blue-400 shadow-lg hover:shadow-2xl px-3 py-1 rounded-md hover:bg-blue-500">Learn More</Link>
{/* <a role='button' href='/Events' class="text-white text-center px-3 py-1 rounded-md bg-gradient-to-r from-pink-400 to-purple-300 hover:from-pink-500 hover:to-blue-300 ">Learn More</a> */}
</div>
        </motion.nav>
    )
}
